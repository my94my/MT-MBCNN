...
class Experiment(object):
    ...
    def __init__(
        ...
        self.center_loss_function = center_loss_function
    ...
    def train_batch(self, inputs, targets):
        ...
        outputs, args = self.model(input_vars)
        loss = self.loss_function(outputs, target_vars, *args)
        # center loss
        if self.center_loss_function is not None:
            loss = loss + self.center_loss_function(outputs, target_vars, *args)
